...
const KEYWORD_TO_ICON: Array<[RegExp, string]> = [
  ...
  [/embalag/i, 'Package'],
  [/petshop|pet[- ]?shop/i, 'PawPrint'],
  [/[oó]tic|[oó]culos/i, 'Glasses'],
  [/presente|personaliz|gift|brinde/i, 'Gift'],
  ...
  [/autom[oó]ve|carro|ve[ií]culo|auto\b|car\b|automotiv/i, 'Car'],
  [/hotelaria|hoteleir/i, 'Building2'],
  [/viag|turismo|travel|hotel\b|pousada|hosped/i, 'Plane'],
