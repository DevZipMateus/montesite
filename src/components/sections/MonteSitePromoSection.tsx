...
const MonteSitePromoSection: React.FC = () => {
  return (
    <section className="py-16 px-8 md:px-14 bg-gradient-to-r from-blue-50 to-indigo-50">
          ...
          <div className="flex-1">
            <FadeIn direction="left">
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Crie rapidamente um site profissional para sua empresa. Preencha o formulário e tenha uma prévia de como ficará o site com um dos modelos disponíveis.
              </p>
              <Button 
                size="lg" 
                className="rounded-full text-lg px-8 py-6 bg-blue-600 hover:bg-blue-700 transition-colors flex items-center gap-2"
                asChild
              >
            ...
            <FadeIn direction="right" delay={200}>
              <div className="relative">
                ...
                <div className="relative overflow-hidden rounded-xl border border-white shadow-2xl bg-white">
                  <img 
                    src="/lovable-uploads/b17abe27-1b0f-4a93-8165-31da17a35552.png" 
