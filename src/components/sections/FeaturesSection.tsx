      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14">
          <FadeIn className="text-center">
            <div className="h-18 w-18 rounded-2xl bg-primary/10 flex items-center justify-center mx-auto mb-6 p-4">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-9 w-9 text-primary">
                <rect width="18" height="18" x="3" y="3" rx="2" />
                <path d="M3 9h18" />
                <path d="M9 21V9" />
              </svg>
            </div>
            <h3 className="text-xl font-semibold mb-4">Design Responsivo</h3>
          ...
          <FadeIn className="text-center" delay={100}>
            ...
            <h3 className="text-xl font-semibold mb-4">Personalização Fácil</h3>
            <p className="text-muted-foreground text-base">
          ...
          <FadeIn className="text-center" delay={200}>
            ...
            <h3 className="text-xl font-semibold mb-4">Otimizado para SEO</h3>
            <p className="text-muted-foreground text-base">
